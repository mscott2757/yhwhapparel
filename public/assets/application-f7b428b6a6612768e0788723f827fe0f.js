...
$(document).ready(function() {
  $('#about-us-hover').mouseover(function() {
      $('#staff-description').css("visibility","visible");
  });

  $('#about-us-hover').mouseout(function() {
      $('#staff-description').css("visibility","hidden");
  });
});
(function() {
    ...
    reload = function(id) {
      return $.ajax({
        ...
        success: function(result) {
          var obj;
          return obj = $("#prayer_" + result.id).find("span").load(document.URL + " #prayer_" + result.id + " span");
        }
      });
    };
    ready = function() {
